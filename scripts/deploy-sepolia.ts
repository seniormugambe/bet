...
async function main() {
  ...
  console.log("\n💸 Funding StakingPool with 0.1 ETH for rewards...");
  ...
  console.log("\n2️⃣  Verify contracts on Etherscan (optional):\n");
  console.log(`npx hardhat verify --network sepolia ${factoryAddress} "${deployer.address}"`);
  console.log(`npx hardhat verify --network sepolia ${stakingPoolAddress} "${deployer.address}"`);
  
  console.log("\n3️⃣  View contracts on Etherscan:\n");
  console.log(`Factory: https://sepolia.etherscan.io/address/${factoryAddress}`);
  console.log(`Staking: https://sepolia.etherscan.io/address/${stakingPoolAddress}`);
