...
async function main() {
  ...
  console.log(`npx hardhat verify --network alfajores ${factoryAddress} "${deployer.address}"`);
  console.log(`npx hardhat verify --network alfajores ${stakingPoolAddress} "${deployer.address}"`);
  
  console.log("\n3️⃣  View contracts on Celoscan:\n");
  console.log(`Factory: https://alfajores.celoscan.io/address/${factoryAddress}`);
  console.log(`Staking: https://alfajores.celoscan.io/address/${stakingPoolAddress}`);
